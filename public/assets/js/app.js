! function(n) {
    ...
    function a() {
        ...
        function e(a, t, e) {
            var n = "",
                s = "";
            t - a < 100 || "Hoy" == e ? (n = "Hoy:", s = a.format("MMM D")) : "Yesterday" == e ? (n = "Yesterday:", s = a.format("MMM D")) : s = a.format("MMM D") + " - " + t.format("MMM D"), i.find("#Select_date").html(s), i.find("#Day_Name").html(n)
        }
