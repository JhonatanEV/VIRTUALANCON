...
class JLPDF extends FPDF{
 ...
 //--------------- Imprimir un parrafo-----------
 function JLprint($cad, $ANCHO, $salto='')
 {  
  ...
  for($i=0; $i<count($lineasN); $i++)
  {
   ...
   {   
    ...
    $leftmargin=0;
    if($i==count($lineasN)-1) $espaciado=0; // <- para la ultima l�nea
   }   
 ...
 //--------------- Imprimir un texto-----------
 function JLCell($txt, $ANCHO, $alineacion='j',$salto='' )
 {
  ...
  for($i=0; $i<count($parrafos); $i++)
  {
    ...
    $this->JLprint($parrafos[$i], $ANCHO, $salto);
    ...
    //--------------- Imprimir un texto-----------
    function JLCell1($txt, $ANCHO, $alineacion='j',$salto='' )
    {
        $this->align=$alineacion;
