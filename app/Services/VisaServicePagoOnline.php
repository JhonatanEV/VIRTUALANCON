...
{   
    ...
    function generateToken() {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://apiprod.vnforapps.com/api.security/v1/security',
    ...
    function generateSesion($amount, $token, $parametros=[]) {
        ...
        $response = json_decode($this->postRequest('https://apiprod.vnforapps.com/api.ecommerce/v2/ecommerce/token/session/651020066', $json, $token));
    ...
    function generateAuthorization($amount, $purchaseNumber, $transactionToken, $token) {
        ...
        $session = json_decode($this->postRequest('https://apiprod.vnforapps.com/api.authorization/v3/authorization/ecommerce/651020066', $json, $token));
        return $session;
    }
