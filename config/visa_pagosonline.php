<?php
return [
    'development' => env('VISA_PAGOSONLINE_ENVIRONMENT', true),
    ...
    //     $environment = env('VISA_PAGOSONLINE_ENVIRONMENT') ? 'development' : 'production';
    //     return config("visa_pagosonline.credentials.{$environment}");
    // },
